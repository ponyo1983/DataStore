...
{
    class IndexRecord:IComparable
    {
        public const int IndexSize = 32;
        public IndexRecord(int index, byte[] buffer, int offset)
        {
            this.Index = index;
        ...
        public bool ConflictWith(IndexRecord other,long maxFileSize)
        {
        ...
        {
            IndexRecord record = obj as IndexRecord;
